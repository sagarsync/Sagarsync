...
export const offlineChatBotResponses = [
  ...
  { keywords: ["coaching", "institute", "student app", "parent app", "management system", "coaching management"], answer: "We deliver a comprehensive Coaching Institute Management System consisting of 3 panels (Institute Admin Panel on desktop, Student app on mobile, Parent app on mobile) and 1 RFID hardware device. Our flagship deployment is live at Elite Career Institute, Makroniya, Sagar, MP, India (GPS: 23.8642° N, 78.7880° E, PIN: 470004), servicing local education centers across Sagar district and the Bundelkhand region." },
  { keywords: ["rfid", "punch", "card", "gate", "attendance", "sms", "alert"], answer: "Our Coaching system includes a physical, wall-mounted RFID/Barcode punch machine at the gate, first deployed in Makroniya, Sagar, MP. When a student scans their card at the gate, it logs entry/exit timestamps in the local database and triggers an automated, instant parent SMS notification, ensuring safety and real-time updates for parents across Sagar." }
];
